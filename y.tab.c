...
{
  "$end", "error", "$undefined", "VAR", "NUMBER", "CHAR_LIT",
  "STRING_LIT", "EQUAL", "GT", "LT", "LTE", "GTE", "ET", "PLUS", "MINUS",
  "STAR", "DIV", "INT", "CHAR", "STRING", "SEMICOLON", "COMMA", "IF",
  "ELSE", "WHILE", "FOR", "'('", "')'", "'{'", "'}'", "$accept", "program",
  "statement_list", "statement", "block", "optional", "declarative",
  "expression", "const", YY_NULLPTR
};
#endif
...
{
      37,   -20,   -20,   -20,   -20,     2,     3,     7,    -2,    -2,
     -19,    16,     1,    37,   -20,    17,     4,   -20,   -20,   -20,
     -20,    56,    66,    -2,   -20,   -20,   -20,   -20,    -2,    -2,
      -2,    -2,    -2,    -2,    -2,    -2,    -2,   -20,    37,    37,
      92,   120,   120,   120,   120,   120,   120,   120,   120,   120,
      -7,     9,    -2,    21,   -20,   106,    -1,   -20,    -2,    37,
      82,    10,    19,   -20,    37,    20,   -20
};
...
{
       4,    25,    27,    28,    29,     0,     0,     0,     0,     0,
       0,     0,     0,     4,     7,     0,     0,    26,    13,    14,
      15,     0,     0,     0,     1,     2,     3,     5,     0,     0,
       0,     0,     0,     0,     0,     0,     0,     6,     4,     4,
       0,    16,    18,    20,    19,    17,    21,    22,    23,    24,
       0,     0,     0,    12,     9,     0,     0,    10,     0,     4,
       0,     0,     0,    11,     4,     0,     8
};
...
{
     -20,   -20,   -13,   -20,   -20,   -20,   -20,     0,   -20
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,    11,    12,    13,    14,    57,    15,    16,    17
};
...
{
      26,     1,     2,     3,     4,    18,    19,    23,    21,    22,
      20,    28,    29,    30,    31,    32,    24,    33,    34,    35,
      36,    25,    53,    40,    37,    50,    51,    59,    41,    42,
      43,    44,    45,    46,    47,    48,    49,    27,    54,    63,
       1,     2,     3,     4,    56,     0,    61,    64,     0,    66,
       0,    65,    55,     0,     5,     6,     7,     0,    60,     8,
       0,     9,    10,    28,    29,    30,    31,    32,     0,    33,
      34,    35,    36,    28,    29,    30,    31,    32,     0,    33,
      34,    35,    36,     0,    38,     0,     0,     0,     0,    28,
      29,    30,    31,    32,    39,    33,    34,    35,    36,    28,
      29,    30,    31,    32,     0,    33,    34,    35,    36,    62,
       0,     0,    52,    28,    29,    30,    31,    32,     0,    33,
      34,    35,    36,     0,     0,     0,    58,    28,    29,    30,
      31,    32,     0,    33,    34,    35,    36
};

static const yytype_int8 yycheck[] =
{
      13,     3,     4,     5,     6,     3,     3,    26,     8,     9,
       3,     7,     8,     9,    10,    11,     0,    13,    14,    15,
      16,    20,    29,    23,    20,    38,    39,    28,    28,    29,
      30,    31,    32,    33,    34,    35,    36,    20,    29,    29,
       3,     4,     5,     6,    23,    -1,    59,    28,    -1,    29,
      -1,    64,    52,    -1,    17,    18,    19,    -1,    58,    22,
      -1,    24,    25,     7,     8,     9,    10,    11,    -1,    13,
      14,    15,    16,     7,     8,     9,    10,    11,    -1,    13,
      14,    15,    16,    -1,    28,    -1,    -1,    -1,    -1,     7,
       8,     9,    10,    11,    28,    13,    14,    15,    16,     7,
       8,     9,    10,    11,    -1,    13,    14,    15,    16,    27,
      -1,    -1,    20,     7,     8,     9,    10,    11,    -1,    13,
...
{
       0,     3,     4,     5,     6,    17,    18,    19,    22,    24,
      25,    31,    32,    33,    34,    36,    37,    38,     3,     3,
       3,    37,    37,    26,     0,    20,    32,    20,     7,     8,
       9,    10,    11,    13,    14,    15,    16,    20,    28,    28,
      37,    37,    37,    37,    37,    37,    37,    37,    37,    37,
      32,    32,    20,    29,    29,    37,    23,    35,    20,    28,
      37,    32,    27,    29,    28,    32,    29
};
...
#line 49 "lang.y" /* yacc.c:1646  */
    {/*display_symbol_table();*/ strcpy((yyval.code),(yyvsp[-1].code)); printf("%s\n",(yyval.code)); exit(0);}
...
#line 57 "lang.y" /* yacc.c:1646  */
    { /*display($1);*/ strcpy((yyval.code),generate_expression_code((yyvsp[-1].nptr),-1)); }
...
#line 61 "lang.y" /* yacc.c:1646  */
    { char i[1000]="",j[1000]="",k[1000]=""; strcpy(i,generate_expression_code((yyvsp[-8].nptr),-1)); strcpy(j,generate_expression_code((yyvsp[-6].nptr),-1)); strcpy(k,generate_expression_code((yyvsp[-4].nptr),-1)); strcpy((yyval.code),generate_code_for(i,j,k,(yyvsp[-1].code))); }
#line 1358 "y.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 62 "lang.y" /* yacc.c:1646  */
    { char h[1000] = ""; strcpy(h, generate_expression_code((yyvsp[-3].nptr),-1)); strcpy((yyval.code),generate_code_while(h,(yyvsp[-1].code))); }
#line 1364 "y.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 63 "lang.y" /* yacc.c:1646  */
    { char h[1000] = ""; strcpy(h, generate_expression_code((yyvsp[-4].nptr),-1)); strcpy((yyval.code),generate_code_if(h,(yyvsp[-2].code),(yyvsp[0].code))); /*printf("****\n%s",$$)*/ }
...
#line 70 "lang.y" /* yacc.c:1646  */
    {make_entry(1,(yyvsp[0].val)); }
#line 1388 "y.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 71 "lang.y" /* yacc.c:1646  */
    { make_entry(2,(yyvsp[0].val)); }
#line 1394 "y.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 72 "lang.y" /* yacc.c:1646  */
    { make_entry(3,(yyvsp[0].val)); }
#line 1400 "y.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 75 "lang.y" /* yacc.c:1646  */
    { (yyval.nptr) = make_node(2,0,(yyvsp[-1].val)); (yyval.nptr) = add_node((yyval.nptr),(yyvsp[-2].nptr),(yyvsp[0].nptr));}
...
#line 84 "lang.y" /* yacc.c:1646  */
    { (yyval.nptr) = make_node(1,0,(yyvsp[0].val)); (yyval.nptr) = add_node((yyval.nptr),NULL,NULL);}
#line 1460 "y.tab.c" /* yacc.c:1646  */
    break;

  case 26:
#line 85 "lang.y" /* yacc.c:1646  */
    { (yyval.nptr) = add_node((yyvsp[0].nptr),NULL,NULL); }
#line 1466 "y.tab.c" /* yacc.c:1646  */
    break;

  case 27:
#line 88 "lang.y" /* yacc.c:1646  */
    { (yyval.nptr) = make_node(0,1,(yyvsp[0].val)); }
#line 1472 "y.tab.c" /* yacc.c:1646  */
    break;

  case 28:
#line 89 "lang.y" /* yacc.c:1646  */
    { (yyval.nptr) = make_node(0,2,(yyvsp[0].val));}
#line 1478 "y.tab.c" /* yacc.c:1646  */
    break;

  case 29:
#line 90 "lang.y" /* yacc.c:1646  */
    { (yyval.nptr) = make_node(0,3,(yyvsp[0].val));}
